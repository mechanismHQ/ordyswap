...
export const contracts = {
  ...
  "txIndex": number | bigint;
    ...
    verifyPrevBlock: {"name":"verify-prev-block","access":"read_only","args":[{"name":"block","type":{"buffer":{"length":80}}},{"name":"parent","type":{"buffer":{"length":80}}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[block: TypedAbiArg<Uint8Array, "block">, parent: TypedAbiArg<Uint8Array, "parent">], Response<boolean, bigint>>,
    verifyPrevBlocks: {"name":"verify-prev-blocks","access":"read_only","args":[{"name":"block","type":{"buffer":{"length":80}}},{"name":"prev-blocks","type":{"list":{"type":{"buffer":{"length":80}},"length":10}}}],"outputs":{"type":{"response":{"ok":{"buffer":{"length":80}},"error":"uint128"}}}} as TypedAbiFunction<[block: TypedAbiArg<Uint8Array, "block">, prevBlocks: TypedAbiArg<Uint8Array[], "prevBlocks">], Response<Uint8Array, bigint>>,
    verifyPrevBlocksFold: {"name":"verify-prev-blocks-fold","access":"read_only","args":[{"name":"parent","type":{"buffer":{"length":80}}},{"name":"next-resp","type":{"response":{"ok":{"buffer":{"length":80}},"error":"uint128"}}}],"outputs":{"type":{"response":{"ok":{"buffer":{"length":80}},"error":"uint128"}}}} as TypedAbiFunction<[parent: TypedAbiArg<Uint8Array, "parent">, nextResp: TypedAbiArg<Response<Uint8Array, number | bigint>, "nextResp">], Response<Uint8Array, bigint>>,
    wasTxMinedPrev: {"name":"was-tx-mined-prev?","access":"read_only","args":[{"name":"block","type":{"tuple":[{"name":"header","type":{"buffer":{"length":80}}},{"name":"height","type":"uint128"}]}},{"name":"prev-blocks","type":{"list":{"type":{"buffer":{"length":80}},"length":10}}},{"name":"tx","type":{"buffer":{"length":1024}}},{"name":"proof","type":{"tuple":[{"name":"hashes","type":{"list":{"type":{"buffer":{"length":32}},"length":12}}},{"name":"tree-depth","type":"uint128"},{"name":"tx-index","type":"uint128"}]}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[block: TypedAbiArg<{
  "header": Uint8Array;
  ...
  "txIndex": number | bigint;
    ...
    wasTxMined: {"name":"was-tx-mined?","access":"read_only","args":[{"name":"block","type":{"tuple":[{"name":"header","type":{"buffer":{"length":80}}},{"name":"height","type":"uint128"}]}},{"name":"tx","type":{"buffer":{"length":1024}}},{"name":"proof","type":{"tuple":[{"name":"hashes","type":{"list":{"type":{"buffer":{"length":32}},"length":12}}},{"name":"tree-depth","type":"uint128"},{"name":"tx-index","type":"uint128"}]}}],"outputs":{"type":{"response":{"ok":"bool","error":"uint128"}}}} as TypedAbiFunction<[block: TypedAbiArg<{
  "header": Uint8Array;
  "height": number | bigint;
...
ordyswap: {
  ...
  "maps": {
    offersAcceptedMap: {"name":"offers-accepted-map","key":"uint128","value":"bool"} as TypedAbiMap<number | bigint, boolean>,
    offersCancelledMap: {"name":"offers-cancelled-map","key":"uint128","value":"uint128"} as TypedAbiMap<number | bigint, bigint>,
    offersMap: {"name":"offers-map","key":"uint128","value":{"tuple":[{"name":"amount","type":"uint128"},{"name":"index","type":"uint128"},{"name":"output","type":{"buffer":{"length":128}}},{"name":"recipient","type":"principal"},{"name":"sender","type":"principal"},{"name":"txid","type":{"buffer":{"length":32}}}]}} as TypedAbiMap<number | bigint, {
  "amount": bigint;
  "index": bigint;
  "output": Uint8Array;
  "recipient": string;
  ...
  "txid": Uint8Array;
    ...
    offersRefundedMap: {"name":"offers-refunded-map","key":"uint128","value":"bool"} as TypedAbiMap<number | bigint, boolean>
  },
  "variables": {
    ERR_INVALID_OFFER: {
